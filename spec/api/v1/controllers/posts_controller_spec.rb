...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    it "PUT update returns http unauthenticated" do
      put :update, id: my_post.id, post: {title: "Update Post Name", body: "This is an updated post body"}
      expect(response).to have_http_status(401)
    end

    it "POST create returns http unauthenticated" do
      post :create, post: {title: "New Post Title", body: "This is a new post body"}
      expect(response).to have_http_status(401)
    end
  ...
  context "unauthorized user" do
    ...
    it "PUT update returns http forbidden" do
      put :update, id: my_post.id, post: {title: "Updat Post Name", body: "This is an updated post body"}
